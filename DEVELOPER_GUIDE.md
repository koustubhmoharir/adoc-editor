...
- `__ENABLE_TEST_GLOBALS__`: Exposes internal stores for inspection execution.
- `__TEST_DISABLE_AUTO_SAVE__`: Prevents the `FileSystemStore` from automatically saving dirty files (defaults to false).
