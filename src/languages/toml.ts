/*
 * Source: https://github.com/microsoft/monaco-editor/blob/f7beb75f38c38b065d26f05760438d84224fdb1a/src/basic-languages/toml/toml.ts
 * 
 * Adapted from the Monaco Editor repository.
 */
...
export function registerToml() {
    ...
    type State = monaco.languages.IMonarchLanguageRule[];
